...
class PhotoPreviewState extends State<PhotoPreviewPage> {
  ...
  PhotoPreviewState({Key key, this.totalAmount}) : super();
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
          child:
              _extendedSlideDelegate?.wholeWidget(slideWidget) ?? slideWidget),
    );
  }
  ...
  ///图片或照片组件
  Widget _toListItemWidget(BuildContext ctx, int index, int totalAmount) {
